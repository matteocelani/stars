...
> **119** starred repositories across **12** categories — last updated on **June 17, 2026 at 06:59 UTC**
...
- [Machine Learning & AI](#machine-learning--ai) (30)
...
- [context-dot-dev/designmd-supply](https://github.com/context-dot-dev/designmd-supply) — A supply of the world's designmds (TypeScript)
- [woltapp/blurhash](https://github.com/woltapp/blurhash) — A very compact representation of a placeholder for an image. (C)
- [TheBoredTeam/boring.notch](https://github.com/TheBoredTeam/boring.notch) — TheBoringNotch: Not so boring notch That Rocks 🎸🎶 (Swift)
- [timing71/web](https://github.com/timing71/web) — Timing71 website (JavaScript)
- [matteocelani/stars](https://github.com/matteocelani/stars) — An automated, categorized list of my GitHub stars. (Python)
- [AlexzanderFlores/Worn-Off-Keys-Discord-Js](https://github.com/AlexzanderFlores/Worn-Off-Keys-Discord-Js) — No description provided. (JavaScript)
- [FrancescoCerio/WhereMI](https://github.com/FrancescoCerio/WhereMI) — Progetto per il corso di Tecnologie Web 2019/2020 Unibo (JavaScript)
